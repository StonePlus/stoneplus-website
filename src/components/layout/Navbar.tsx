  ...
  return (
    <header
      className={classNames(
        ...
        "w-full fixed z-50 hover:bg-gunmetal-950"
      )}
    >
      <div className="navbar px-10 xl:px-4 max-w-screen-2xl mx-auto w-screen">
        <div className="navbar-start">
          <a className="btn btn-ghost px-0 hover:bg-transparent normal-case text-2xl text-gunmetal-50 hover:text-white font-bold tracking-tight">
            <Image
              alt="StonePlus Logo"
              src={StoneLogo}
              width={24}
        ...
        <div className="navbar-end">
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <DynamicHeroIcon icon="Bars3BottomRightIcon" />
            </label>
